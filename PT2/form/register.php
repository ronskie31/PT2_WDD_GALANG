                        ...
                        <form>
                            ...
                            */
                            ...
                            if($con){
                                ...
                                $query = "insert into users_tbl(firstname, lastname, email, birthdate, address, password, cpassword, reg_date) values('$fname','$lname','$email','$bdate','$address','$pass','$cpass',NOW())";
